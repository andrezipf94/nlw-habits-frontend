...
export function NewHabitForm() {
  ...
  function handleWeekdayToggle(weekday: number) {
    if (weekdays.includes(weekday)) {
      const weekdaysWithoutProvidedWeekday = weekdays.filter(
        (weekdayAtArray) => weekdayAtArray !== weekday
      );
      return setWeekdays(weekdaysWithoutProvidedWeekday);
    }

    return setWeekdays([...weekdays, weekday]);
  }
